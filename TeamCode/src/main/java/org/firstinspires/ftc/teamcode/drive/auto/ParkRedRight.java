...
@Autonomous(name = "RED_RIGHT_PARKING", group = "PARKING", preselectTeleOp = "FINAL_TELEOP")
public class ParkRedRight extends CommandOpMode {
    ...
    private Pose2d startPose = new Pose2d(31.9097518174, -58.36807593792066, Math.toRadians(90.00));
