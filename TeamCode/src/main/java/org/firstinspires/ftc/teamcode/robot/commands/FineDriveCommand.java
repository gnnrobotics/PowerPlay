...
// eventually change to drive teleop or smth
    ...
    public FineDriveCommand(DriveSubsystem subsystem, DoubleSupplier strafeSpeed, DoubleSupplier forwardSpeed, DoubleSupplier turnSpeed) {
    ...
    public void execute()
    {
        ...
        m_DriveSubsystem.drivePower(frontLeftPower * fineMotor, frontRightPower * fineMotor, backLeftPower * fineMotor, backRightPower * fineMotor);
    }
